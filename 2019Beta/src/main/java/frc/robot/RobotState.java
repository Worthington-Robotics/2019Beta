...
public class RobotState {
    ...
    public synchronized Twist2d generateOdometryFromSensors(double leftEncoderDeltaDistance, double rightEncoderDeltaDistance, Rotation2d current_gyro_angle) {
        final Pose2d last_measurement = getLatestFieldToVehicle().getValue();
        final Twist2d delta = Kinematics.forwardKinematics(last_measurement.getRotation(), leftEncoderDeltaDistance, rightEncoderDeltaDistance, current_gyro_angle);
